...
export class ProductosService {
  ...
  ListadoDeProveedores(): Observable<Proveedor[]>{
    return this.http.get<Proveedor[]>("https://localhost:44328/api/Producto/listadoProveedores/");
  }

  agregarProducto(producto: Producto): Observable<boolean>{
    return this.http.post<boolean>("https://localhost:44328/api/Producto/agregar/" , producto);
  }

  editarProducto(producto: Producto): Observable<boolean>{
    return this.http.put<boolean>("https://localhost:44328/api/Producto/editar" , producto);
  }
}
