...
export class AgregarProductoPage implements OnInit {
  ...
  constructor(private productoServicio: ProductosService, public loadingController: LoadingController,public toastController: ToastController,  private estado: ActivatedRoute) { }
